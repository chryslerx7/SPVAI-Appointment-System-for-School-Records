...
if ($user) {
    if ($user['role'] === 'admin') {
        ...
        echo json_encode(['valid' => true, 'msg' => 'Admin Login successful!', 'url' => 'reservation.php']);
    } else {
...
if ($legacyUser && md5($password) === $legacyUser['user_password']) {
    ...
    try {
        ...
        echo json_encode(['valid' => true, 'msg' => 'Admin Login successful (Migrated)!', 'url' => 'reservation.php']);
    } catch (Exception $e) {
