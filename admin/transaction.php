...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.php">SPVAI Admin</a>
		<ul class="nav navbar-nav">
			<li class=""><a href="reservation.php">Reserved
			<span class="glyphicon glyphicon-list" aria-hidden="true"></span>
			</a></li>
			<li class="active"><a href="transaction.php">
	...
	$('.tenPercent').click(function(event) {
		...
		$.ajax({
				...
				success: function (data) {
					// console.log(data);
					if(data.valid == false){
						$('#modal-message').find('.modal-body').text('Student is Already Refunded!');
						
					}else if(data.valid == true){
						showAllTransaction();
						$('#modal-message').find('.modal-body').text('Student Refunded Successfully!');
					}
